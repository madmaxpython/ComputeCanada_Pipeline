...
def TransferGlobus(SOURCE_ENDPOINT_ID,
                   CLIENT_ID,
   ...
   """
    ...
    tdata = TransferData(transfer, SOURCE_ENDPOINT_ID,
                         DESTINATION_ENDPOINT_ID,
                         label="File Transfer",
                         sync_level="checksum")
    if IS_A_FOLDER:
        tdata.add_item(SOURCE_FOLDER, DESTINATION_FOLDER + '/' + SOURCE_FOLDER.split('/')[-1], recursive=IS_A_FOLDER)
